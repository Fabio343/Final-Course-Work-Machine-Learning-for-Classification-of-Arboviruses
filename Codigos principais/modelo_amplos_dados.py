...
base_unificada5=base_unificada5.merge(base_total[['Subject_ID','CLASSIFICACAO FINAL','HT 1','HB 1','PLAQ 1','TGO 1','TGP 1']],how='left',on=['Subject_ID'])
...
amostra_paci=amostra_paci[['fl_severidade','HT 1','HB 1','PLAQ 1','TGO 1','TGP 1','IGG_nao_reativo','IGM_nao_reativo','PCR_nao_reativo','IGG_reativo','IGM_reativo','PCR_reativo']]
